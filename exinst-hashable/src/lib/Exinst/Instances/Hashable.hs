...
instance forall (f1 :: k1 -> *)
  ...
  where
    ...
    hashWithSalt salt some1 = withSome1 some1 $ \sa1 (x :: f1 a1) ->
       case dict1 sa1 :: Dict (Hashable (f1 a1)) of
          Dict -> salt0 `hashWithSalt` salt `hashWithSalt` x
...
instance forall (f2 :: k2 -> k1 -> *)
  ...
  where
    {-# INLINABLE hashWithSalt #-}
    hashWithSalt salt some2 = withSome2 some2 $ \sa2 sa1 (x :: f2 a2 a1) ->
...
instance forall (f3 :: k3 -> k2 -> k1 -> *)
  ...
  where
    {-# INLINABLE hashWithSalt #-}
    hashWithSalt salt some3 = withSome3 some3 $ \sa3 sa2 sa1 (x :: f3 a3 a2 a1) ->
...
instance forall (f4 :: k4 -> k3 -> k2 -> k1 -> *)
  ...
  where
    {-# INLINABLE hashWithSalt #-}
    hashWithSalt salt some4 = withSome4 some4 $ \sa4 sa3 sa2 sa1 (x :: f4 a4 a3 a2 a1) ->
